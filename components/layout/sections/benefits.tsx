...
const benefitList: BenefitsProps[] = [
  ...
  },
  {
    ...
    description: "Trusted by global and regional brands in toys and textiles.",
  },
];
      ...
      <div className="grid lg:grid-cols-2 place-items-center lg:gap-24">
        <div>
          ...
          <p className="text-xl text-muted-foreground mb-8">
            We help brands and manufacturers meet quality standards and volume
            targets with consistent outcomes and reliable timelines.
          </p>
        </div>
